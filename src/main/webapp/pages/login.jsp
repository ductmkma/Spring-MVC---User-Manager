			...
			<div class="col-md-4">
			 ...
			 <div class="col-md-4" id="form-div">
				...
				<img style="width: 140px;height: 100px;" src="http://www.aksharachits.com/home/assets/images/login_img.png" class="img-responsive" alt="" />
					<h3 id="titleLogin"><spring:message code="titleform"  ></spring:message></h3>
				...
				<%-- <div class="col-md-4" id="form-div">
				<section class="login-form">
				<form modelAttribute="user" method="post" action="login" role="login" name="frm-login" id="frm-login">
				<img style="width: 140px;height: 100px;" src="http://www.aksharachits.com/home/assets/images/login_img.png" class="img-responsive" alt="" />
					<h3 id="titleLogin"><spring:message code="titleform"  ></spring:message></h3>
					<input name="username" type="text" placeholder="<spring:message code="username"  ></spring:message>" class="form-control input-lg" value="" />
					<input name="password" type="password" class="form-control input-lg" id="password" placeholder="<spring:message code="password"  ></spring:message>" />
					<p id="messeage" style="color:red;"><c:out value="${err}"></c:out> </p>
					<!-- <div class="pwstrength_viewport_progress"></div> -->
					<button class="btn btn-lg btn-block" id="login"><spring:message code="login"  ></spring:message></button>
					<div>
					<a href="<%=request.getContextPath() %>/forgotpassword" style="text-decoration: none;">Quên mật khẩu ?</a>
					 <br>Language :
  					<a href="?language=en">English  </a> |
