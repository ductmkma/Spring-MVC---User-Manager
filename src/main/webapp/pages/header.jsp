...
<head>
  ...
  <title>ZENT | Quản lý người dùng</title>
  ...
  <link ref="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.8.0/css/bootstrap-datepicker.min.css"> 
...
<style type="text/css">
	#tableuser_filter,#tableuser_length{
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Zent</b>KMA</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
	           <a href="?language=vi">
	              <img width="20px" height="20px" alt="iconVN" src="http://icons.iconarchive.com/icons/iconscity/flags/256/vietnam-icon.png">
	              <span class="">Việt Nam</span>
	           </a>
          </li>
           <li class="dropdown">
	           <a href="?language=en">
	              <img width="20px" height="20px" alt="iconVN" src="https://cdn2.iconfinder.com/data/icons/world-flags-1-1/100/Britain-512.png">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="http://localhost:8080/Spring-MVC/index" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span><spring:message code="tree"></spring:message> </span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="#"><i class="fa fa-users" aria-hidden="true"></i> <spring:message code="usermanager"></spring:message></a></li>
          </ul>
        </li>
        <li><a href="https://adminlte.io/docs"><i class="fa fa-book"></i> <span><spring:message code="document"></spring:message></span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>